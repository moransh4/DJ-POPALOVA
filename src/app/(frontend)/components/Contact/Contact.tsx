  ...
  return (
    ...
    >
      ...
      <div className="contact-content">
        <div className="social-media-wrapper" role="group" aria-labelledby="social-heading">
          <h3 id="social-heading" className="sr-only">
            עקבו אחרי ברשתות
          </h3>
          <ul className="social-icons" aria-label="קישורים לרשתות חברתיות">
            <li>
              <a
                href="https://www.facebook.com/vadim.poplavsky.9"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.instagram.com/popalova"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
            ...
            <li>
              <a
                href="https://www.youtube.com/@djvadimpoplavsky"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
                aria-label="YouTube"
              >
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 2 12c0 2.64.28 5.38 1.46 6.58a2.78 2.78 0 0 0 1.94 2C5.12 20 12 20 12 20s6.88 0 8.6-.42a2.78 2.78 0 0 0 1.94-2C22.72 17.38 23 14.64 23 12c0-2.64-.28-5.38-1.46-6.58z"></path>
          ...
          <div className="contact-info-wrapper" aria-label="פרטי יצירת קשר">
            <a
              className="phone-number"
              href="tel:+972544432984"
              aria-label="התקשרו למספר 0544432984"
            >
              054-4432984
            </a>
            <a
